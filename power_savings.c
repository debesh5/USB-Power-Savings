...

{
  ...
  double dp_up_bw_demand[15], dp_dn_bw_demand[15];
                 ...
                 // Projected B/W demand in each direction

  double net_up_demand=0, net_dn_demand=0; // represents projected b/w demand
  ...
  printf("Hub UP utilization: up: %lf, dn: %lf, link (U2U3): %lf, link(U1): %lf\n",up_util_up,up_util_dn,up_util_link_U2U3,up_util_link_U1);
